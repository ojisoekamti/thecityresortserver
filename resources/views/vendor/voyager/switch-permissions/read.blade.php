...
@section('page_header')
    <h1 class="page-title">
        ...
        @endcan
        <a href="{{ url('admin/switch-permissions-print/' . $dataTypeContent->getKey()) }}" class="btn btn-warning">
            <i class="glyphicon glyphicon-print"></i> <span class="hidden-xs hidden-sm">Print</span>
        </a>
    </h1>

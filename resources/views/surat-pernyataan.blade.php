...
<body>
    ...
    <p style="text-align: center"><br><u><b>SURAT PERNYATAAN</b> </u><br>No.
        1222/SKP/Sec/{{ date('M') }}/{{ date('Y') }}</p>
    <br>
    ...
    <p>Menyatakan dengan sebenar-benarnya pada hari ini {{ date("l") }} Tanggal {{ date("d") }} Bulan {{ date("m") }} Tahun {{ date("Y") }} pukul {{ date("h:m:s") }} WIB</p>
    <p>{{ str_pad("",1500," . ") }}</p>
    <table style="width:100%">
        <tr>
            <td style="width: 50%">
